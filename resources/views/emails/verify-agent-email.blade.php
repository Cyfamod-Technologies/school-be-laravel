...
<head>
    <meta charset="UTF-8">
    <title>Verify your agent email</title>
</head>
<body style="font-family: Arial, sans-serif; background-color:#f6f6f6; padding:24px; color:#1f2937;">
    <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px; margin:0 auto; background-color:#ffffff; border-radius:8px; padding:32px;">
        <tr>
            <td>
                <h2 style="margin-top:0; color:#111827;">Hi {{ $agent->full_name }},</h2>
                <p style="line-height:1.5; margin-bottom:16px;">
                    Thanks for registering as an agent on {{ config('app.name') }}.
                    Please verify your email address before signing in.
                </p>
                <p style="line-height:1.5; margin-bottom:16px;">
                    After clicking verify, return to login and sign in. If you don't see this email, check your inbox and SPAM folder.
                </p>
